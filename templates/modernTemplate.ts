...
const generateModernStyles = (options: TemplateOptions): string => {
...
export const generateModernCvHtml = (data: ResumeData, options: TemplateOptions): string => {
